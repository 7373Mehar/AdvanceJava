...
<html>
 ...
 PreparedStatement ps=(PreparedStatement)application.getAttribute("reportad1");
 ps.setString(1,request.getParameter("eid"));
 ps.setObject(2,LocalDate.parse(date));
  ...
  <div class='container'>
   <div class='card col-md-12 mx-auto'>
    <div class='card-body'>
     <%if(!rst.next()){%>
       <div class='dv'>
        <label class='la' style='color:red'>Employee had not gone outside on date <%=date%></label>
       </div>
     <%}
     else
     {
